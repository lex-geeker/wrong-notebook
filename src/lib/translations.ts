...
export const translations = {
    en: {
        ...
        settings: {
            ...
            importResultDesc: "Imported {subjects} notebooks, {tags} tags, {items} error items and {records} practice records; ignored {schedules} legacy review schedules.",
    ...
    zh: {
        ...
        settings: {
            ...
            importResult: "导入结果",
            importResultDesc: "已导入 {subjects} 个笔记本、{tags} 个标签、{items} 道错题和 {records} 条练习记录；已忽略 {schedules} 条旧复习计划。",
            exportAllData: "导出全部",
