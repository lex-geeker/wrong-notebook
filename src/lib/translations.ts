...
export const translations = {
    en: {
        ...
        notebook: {
            ...
            selectAllFailed: "Failed to select all items",
            deleteSelected: "Delete Selected",
            selectedCount: "{count} selected",
            confirmBatchDelete: "Delete {count} items?",
            batchDeleteSuccess: "Deleted successfully",
            batchDeletePartial: "Deleted {deleted}; {remaining} remain selected",
        },
        notebooks: {
            title: "My Notebooks",
        ...
        practice: {
            ...
            batch: {
                ...
                ebbinghaus: "Ebbinghaus review",
                legacyKnowledge: "By topic",
                subject: "Notebook",
                allSubjects: "All notebooks",
                count: "Question count",
                source: "Question source",
                original: "Original",
                variant: "Variant questions",
                fallback: "Original (variant unavailable)",
                focused: "Practice from the selected question",
                start: "Start practice",
                starting: "Building set...",
                history: "Recent sessions",
                noHistory: "No practice sessions yet.",
                noDue: "No review questions are due today.",
                noDueSubject: "No reviews are due today for the selected notebook.",
                todayDue: "Reviews due today",
                todayDueCount: "Up to 5 questions, ready for paper practice",
                printToday: "Create and print",
                question: "Question",
                answered: "answered",
                ...
                again: "New set",
                createError: "Could not create this practice set.",
                loadError: "Could not load this practice session.",
                submitError: "Could not save this answer.",
                paperGrading: "Grade on phone",
                paperGradingTitle: "Grade paper practice",
                paperGradingProgress: "{marked}/{total} marked",
                paperCorrect: "Correct",
                paperIncorrect: "Incorrect",
                paperSave: "Save results",
                paperSaved: "Results saved",
                paperSaveError: "Could not save these results.",
        ...
        settings: {
            ...
            importResultDesc: "Imported {users} users, {subjects} notebooks, {tags} tags, {items} error items, {sessions} practice sessions and {records} practice records.",
        ...
        printPreview: {
            ...
            columnsPerRow: "Questions per row",
            reserveAnswerSpace: "Reserve answer space",
    ...
    zh: {
        ...
        notebook: {
            ...
            selectMode: "多选",
            cancelSelect: "取消",
            selectAll: "全选 {count} 题",
            selectNone: "全不选",
            selectingAll: "正在全选...",
            selectAllFailed: "无法全选题目",
            deleteSelected: "删除选中",
            selectedCount: "已选 {count} 项",
            confirmBatchDelete: "确定删除 {count} 道错题？",
            batchDeleteSuccess: "删除成功",
            batchDeletePartial: "已删除 {deleted} 题，剩余 {remaining} 题仍保持选中",
        },
        notebooks: {
            title: "我的错题本",
        ...
        practice: {
            ...
            batch: {
                ...
                noHistory: "还没有练习记录。",
                noDue: "今天没有到期题目。",
                noDueSubject: "所选科目今日暂无到期复习。",
                todayDue: "今日到期复习",
                todayDueCount: "最多 5 题，生成后直接打印",
                printToday: "生成并打印",
                question: "第",
                answered: "题已答",
                progress: "答题进度",
                ...
                review: "查看答题",
                again: "再练一组",
                createError: "无法创建这组练习。",
                loadError: "无法加载练习记录。",
                submitError: "无法保存答案。",
                paperGrading: "手机批改",
                paperGradingTitle: "批改纸上练习",
                paperGradingProgress: "已标记 {marked}/{total} 题",
                paperCorrect: "做对了",
                paperIncorrect: "做错了",
                paperSave: "保存批改结果",
                paperSaved: "批改结果已保存",
                paperSaveError: "无法保存批改结果。",
                backHome: "返回首页",
                home: "首页",
            },
            generate: "生成练习题",
        ...
        settings: {
            ...
            importResult: "导入结果",
            importResultDesc: "已导入 {users} 个用户、{subjects} 个笔记本、{tags} 个标签、{items} 道错题、{sessions} 个练习会话和 {records} 条练习记录。",
            exportAllData: "导出全部",
